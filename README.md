...
pixi add kubernetes-helm
# for installing globally
pixi global install kubernetes-helm
```
...
It is possible to list all of the versions of `kubernetes-helm` available on your platform:
...
```
pixi search kubernetes-helm --channel conda-forge
```
